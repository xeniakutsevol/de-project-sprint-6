...
hk_user_id bigint not null CONSTRAINT fk_l_user_message_user REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_users (hk_user_id),
hk_message_id bigint not null CONSTRAINT fk_l_user_message_message REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_dialogs (hk_message_id),
load_dt datetime,
load_src varchar(20)
)
order by load_dt
...
where hash(hd.hk_message_id,hu.hk_user_id) not in (select hk_l_user_message from XENIAKUTSEVOL_GMAIL_COM__DWH.l_user_message);
...
hk_message_id bigint not null CONSTRAINT fk_l_groups_dialogs_message REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_dialogs (hk_message_id),
hk_group_id bigint not null CONSTRAINT fk_l_groups_dialogs_group REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_groups (hk_group_id),
load_dt datetime,
load_src varchar(20)
)
order by load_dt
...
left join XENIAKUTSEVOL_GMAIL_COM__DWH.h_dialogs as hd on d.message_id = hd.message_id
where hg.hk_group_id is not null and hash(hg.hk_group_id,hd.hk_message_id) not in (select hk_l_groups_dialogs from XENIAKUTSEVOL_GMAIL_COM__DWH.l_groups_dialogs);
...
hk_user_id bigint not null CONSTRAINT fk_l_admins_user REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_users (hk_user_id),
hk_group_id bigint not null CONSTRAINT fk_l_admins_group REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_groups (hk_group_id),
load_dt datetime,
load_src varchar(20)
)
order by load_dt
...
(
hk_admin_id bigint not null CONSTRAINT fk_s_admins_l_admins REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.l_admins (hk_l_admin_id),
is_admin boolean,
admin_from datetime,
load_dt datetime,
load_src varchar(20)
...
hk_user_id bigint not null CONSTRAINT fk_s_user_socdem_h_users REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_users (hk_user_id),
country varchar(200),
age integer,
load_dt datetime,
load_src varchar(20)
...
hk_user_id bigint not null CONSTRAINT fk_s_user_chatinfo_h_users REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_users (hk_user_id),
chat_name varchar(200),
load_dt datetime,
load_src varchar(20)
)
...
hk_group_id bigint not null CONSTRAINT fk_s_group_name_h_groups REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_groups (hk_group_id),
group_name varchar(100),
load_dt datetime,
load_src varchar(20)
)
...
hk_group_id bigint not null CONSTRAINT fk_s_group_private_status_h_groups REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_groups (hk_group_id),
is_private boolean,
load_dt datetime,
load_src varchar(20)
)
...
hk_message_id bigint not null CONSTRAINT fk_s_dialog_info_h_dialogs REFERENCES XENIAKUTSEVOL_GMAIL_COM__DWH.h_dialogs (hk_message_id),
message varchar(1000),
